...
dataset = pd.read_csv(f'%23balburdia2.csv',encoding='utf-8')
dataset.count()

dataset[dataset.CLASSIFICACAO == '0'].count()

dataset[dataset.CLASSIFICACAO == '1'].count()
...
classes = dataset["CLASSIFICACAO"].values.astype('U')
classes
